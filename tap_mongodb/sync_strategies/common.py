...
from tap_mongodb.errors import UnsupportedReplicationKeyTypeException, MongoInvalidDateTimeException, SyncException
...
def row_to_singer_record(stream, row, version, time_extracted):
    ...
    try:
        ...
        raise SyncException("Error syncing collection {}, object ID {} - {}".format(stream["tap_stream_id"], row['_id'], ex))
